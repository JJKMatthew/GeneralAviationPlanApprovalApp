...
{
    public partial class AlreadyApprovalForm : Form
    {   
        private AdminUser admainForm1;
        UserInfo currentUser;
        int userID;
        private string connectionString;
        public AlreadyApprovalForm(UserInfo UserInfo , AdminUser admainForm)
        {
            InitializeComponent();
        ...
        private void AlreadyApprovalForm_Load(object sender, EventArgs e)
        {
            // TODO: 这行代码将数据加载到表“gAPADataSet1.Approval_Log”中。您可以根据需要移动或移除它。
            this.approval_LogTableAdapter.Fill(this.gAPADataSet1.Approval_Log);
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string sql = @"
                        ...
                        WHERE al.ReviewerID = @ReviewerID
