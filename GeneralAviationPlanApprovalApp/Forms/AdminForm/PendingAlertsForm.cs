...
{
    public partial class PendingAlertsForm : Form
    {
        private UserInfo currentUser;
        // 数据库连接字符串
        private string connectionString;
        public PendingAlertsForm(UserInfo UserInfo)
        {
            InitializeComponent();
        ...
        private void PendingAlertsForm_Load(object sender, EventArgs e)
        {
            LoadAllPendingAlerts();
        }
        private void LoadAllPendingAlerts()
        {
            try
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请先选择要推送的告警通知！", "提示",
                    MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            DialogResult result = MessageBox.Show($"确定要推送选中的 {dataGridView1.SelectedRows.Count} 个告警通知吗？",
                "确认推送", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
